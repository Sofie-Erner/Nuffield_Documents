...
ch = Parameter(name = 'ch',
               nature = 'internal',
               type = 'real',
               value = 'cmath.cos(thetaH)',
               texname = '\\text{Cos} \\theta _h')

sh = Parameter(name = 'sh',
               nature = 'internal',
               type = 'real',
               value = 'cmath.sin(thetaH)',
               texname = '\\text{Sin} \\theta _h')
...
kappa2 = Parameter(name = 'kappa2',
                   nature = 'internal',
                   type = 'real',
                   value = '(MhS**2 + lamS*vev**2)/2.',
                   texname = '\\kappa _2 \\text{MR$\\$$Null}\\to \\text{Coefficient of the quadratic piece of the Dark Scalar potential}')
...
kappa1 = Parameter(name = 'kappa1',
                   nature = 'internal',
                   type = 'real',
                   value = '(muS*vev**2)/2.',
                   texname = '\\kappa _1 \\text{MR$\\$$Null}\\to \\text{Coefficient of the linear piece of Dark Scalar potential}')

muH = Parameter(name = 'muH',
                nature = 'internal',
                type = 'real',
                value = 'cmath.sqrt(lamH*vev**2)',
                texname = '\\mu _H')

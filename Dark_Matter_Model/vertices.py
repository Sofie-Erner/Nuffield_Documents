...
V_9 = Vertex(name = 'V_9',
             particles = [ P.G__minus__, P.G__plus__, P.S ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
             couplings = {(0,0):C.GC_53})
...
V_13 = Vertex(name = 'V_13',
              particles = [ P.G0, P.G0, P.S, P.S ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_61})

V_14 = Vertex(name = 'V_14',
              particles = [ P.G__minus__, P.G__plus__, P.S, P.S ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_61})

V_15 = Vertex(name = 'V_15',
              particles = [ P.H, P.H, P.S, P.S ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
...
V_22 = Vertex(name = 'V_22',
              particles = [ P.G0, P.G0, P.H, P.S ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_60})

V_23 = Vertex(name = 'V_23',
              particles = [ P.G__minus__, P.G__plus__, P.H, P.S ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_60})

V_24 = Vertex(name = 'V_24',
              particles = [ P.H, P.H, P.H, P.S ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_65})

V_25 = Vertex(name = 'V_25',
              particles = [ P.H, P.S, P.S ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
...
V_41 = Vertex(name = 'V_41',
              particles = [ P.ghWm, P.ghWm__tilde__, P.S ],
              color = [ '1' ],
              lorentz = [ L.UUS1 ],
...
V_50 = Vertex(name = 'V_50',
              particles = [ P.ghWp, P.ghWp__tilde__, P.S ],
              color = [ '1' ],
              lorentz = [ L.UUS1 ],
              couplings = {(0,0):C.GC_121})
...
V_60 = Vertex(name = 'V_60',
              particles = [ P.ghZ, P.ghZ__tilde__, P.S ],
              color = [ '1' ],
              lorentz = [ L.UUS1 ],
...
V_80 = Vertex(name = 'V_80',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_161,(0,1):C.GC_161})
...
V_103 = Vertex(name = 'V_103',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_173,(0,1):C.GC_172})

V_104 = Vertex(name = 'V_104',
               particles = [ P.c__tilde__, P.c, P.G0 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_141,(0,1):C.GC_140})
...
V_107 = Vertex(name = 'V_107',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_142,(0,1):C.GC_142})

V_108 = Vertex(name = 'V_108',
               particles = [ P.t__tilde__, P.t, P.H ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_164,(0,1):C.GC_164})

V_109 = Vertex(name = 'V_109',
               particles = [ P.u__tilde__, P.u, P.S ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_175,(0,1):C.GC_175})
...
V_114 = Vertex(name = 'V_114',
               particles = [ P.a, P.W__minus__, P.G__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_118 = Vertex(name = 'V_118',
               particles = [ P.W__minus__, P.G__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
...
V_122 = Vertex(name = 'V_122',
               particles = [ P.a, P.W__plus__, P.G__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_126 = Vertex(name = 'V_126',
               particles = [ P.W__plus__, P.G__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_95})
...
V_130 = Vertex(name = 'V_130',
               particles = [ P.W__minus__, P.W__plus__, P.H, P.S ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_146 = Vertex(name = 'V_146',
               particles = [ P.W__minus__, P.Z, P.G__plus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_150 = Vertex(name = 'V_150',
               particles = [ P.W__plus__, P.Z, P.G__minus__, P.S ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_200 = Vertex(name = 'V_200',
               ...
               couplings = {(0,0):C.GC_102,(0,1):C.GC_99})
...
V_203 = Vertex(name = 'V_203',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_101,(0,1):C.GC_98})
...
V_209 = Vertex(name = 'V_209',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_103,(0,1):C.GC_100})
